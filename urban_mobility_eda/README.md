...
![Operational Overview](dashboards/screenshots/operational_overview.png)
![Battery Threshold Analysis](dashboards/screenshots/battery_threshold.png)

---

*Data has been anonymised and the company name removed to respect 
confidentiality. Methodology and code are entirely original work.*